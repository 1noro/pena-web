...
SET @semana_id = 202218;

INSERT INTO semana (id, numero, fecha_lunes, participantes, total_ganado)
    VALUES (@semana_id, 18, '2022-05-02', 11, 0);

-- BONOLOTO --------------------------------------------------------------------
CALL insert_boleto_bonoloto(@semana_id, 05, 13, 15, 25, 34, 43, 48, 08);

-- EUROMILLON ------------------------------------------------------------------
-- CALL insert_boleto_euromillon2m(@semana_id, NN, NN, NN, NN, NN, EE, EE);
-- CALL insert_boleto_euromillon2m(@semana_id, 01, 02, 03, 04, 05, 01, 02);


-- CALL insert_boleto_euromillon2v(@semana_id, NN, NN, NN, NN, NN, EE, EE);
-- CALL insert_boleto_euromillon2v(@semana_id, 10, 20, 30, 40, 41, 10, 20);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 69205);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 29617);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 16586);
CALL insert_boleto_lot_nac_xov(@semana_id, 69187);
CALL insert_boleto_lot_nac_xov(@semana_id, 11188);
CALL insert_boleto_lot_nac_xov(@semana_id, 48389);
