...
CALL insert_boleto_lototurf6s(@semana_id, 04, 13, 14, 15, 22, 25, 00, 01);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 48205);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 59919);
CALL insert_boleto_lot_nac_xov(@semana_id, 93820);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 02731);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 64438);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 82445);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 94380);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 96586);
...
CALL insert_boleto_lot_nac_xov(@semana_id, 01391);
CALL insert_boleto_lot_nac_xov(@semana_id, 06092);
