...
INSERT INTO semana (id, numero, fecha_lunes, participantes, total_ganado)
    VALUES (@semana_id, 13, '2022-03-28', 11, 1050.27);
...
CALL insert_boleto_lot_nac_sab(@semana_id, 60101);
...
CALL insert_boleto_lot_nac_sab(@semana_id, 62445);
...
CALL insert_boleto_lot_nac_sab(@semana_id, 00457);
...
CALL insert_boleto_lot_nac_sab(@semana_id, 56969);
...
CALL insert_boleto_lot_nac_sab(@semana_id, 26586);
...
CALL insert_boleto_lot_nac_sab(@semana_id, 53391);
CALL insert_boleto_lot_nac_sab(@semana_id, 06092);
